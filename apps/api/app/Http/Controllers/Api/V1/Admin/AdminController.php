    ...
    public function dashboard(): JsonResponse
    {
        return $this->successResponse([
            'stats' => [
                ...
                'pending_organizations' => Organization::where('status', ApprovalStatus::PENDING_REVIEW)->count(),
                'total_brands' => Brand::count(),
                'pending_brands' => Brand::where('status', ApprovalStatus::PENDING_REVIEW)->count(),
